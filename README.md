...
- [Plumix](https://github.com/Plumix-Net/Plumix) - Flutter-inspired UI framework for .NET - build declarative, widget-based UIs in C# on top of Avalonia, with Material and Cupertino widget sets.
